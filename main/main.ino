...
void loop() {
  ...
  if (modeButton != lastModeButton && modeButton) {
    ...
    modeGroupGroup = -1;
    modeRandomGroupCounter = GROUP_LEDS;
    modeYesNoChance = 50;
  }
